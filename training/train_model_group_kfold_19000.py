...
MODEL_OUTPUT_PATH = "models/leak_classifier_logistic_19000_groupkfold.pkl"
VECTORIZER_OUTPUT_PATH = "models/tfidf_vectorizer_logistic_19000_groupkfold.pkl"
RESULTS_OUTPUT_PATH = "output/logistic_groupkfold_results_19000.csv"
...
def main():
    ...
    print()
    print("=" * 60)
    print("Running TF-IDF + Logistic Regression with GroupKFold on 19k dataset")
    print("=" * 60)

    for fold_index, (train_index, test_index) in enumerate(group_kfold.split(X, y, groups), start=1):
        print()
        print("=" * 60)
    ...
    print()
    print(f"Saved Logistic Regression GroupKFold results to: {RESULTS_OUTPUT_PATH}")

    print()
    print("Training final Logistic Regression model on full 19k dataset...")
