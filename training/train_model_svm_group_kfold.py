...
MODEL_OUTPUT_PATH = "models/leak_classifier_svm_18000_groupkfold.pkl"
VECTORIZER_OUTPUT_PATH = "models/tfidf_vectorizer_svm_18000_groupkfold.pkl"
RESULTS_OUTPUT_PATH = "output/svm_groupkfold_results_18000.csv"
...
def main():
    ...
    print()
    print("=" * 60)
    print("Running TF-IDF + Linear SVM with GroupKFold")
    print("=" * 60)
